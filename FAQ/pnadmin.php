...
function FAQ_admin_updateconfig()
{
    ...
    ModUtil::setVar('FAQ', 'itemsperpage', $itemsperpage);

    $enablecategorization = (bool)FormUtil::getPassedValue('enablecategorization', false, 'POST');
    ModUtil::setVar('FAQ', 'enablecategorization', $enablecategorization);

    $addcategorytitletopermalink = (bool)FormUtil::getPassedValue('addcategorytitletopermalink', false, 'POST');
    ModUtil::setVar('FAQ', 'addcategorytitletopermalink', $addcategorytitletopermalink);
   ...
   // Let any other modules know that the modules configuration has been updated
    ModUtil::callHooks('module','updateconfig','FAQ', array('module' => 'FAQ'));
