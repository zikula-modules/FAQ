...
class FAQ_Controller_User extends Zikula_AbstractController
{
    ...
    public function main()
    {
        ...
        return $this->view->fetch('faq_user_main.htm');
    }
    ...
    public function view($args)
    {
        ...
        foreach ($items as $item) {
            if (SecurityUtil::checkPermission( 'FAQ::', "$item[faqid]::", ACCESS_OVERVIEW)) {
                ...
                $faqitems[] = $this->view->fetch('faq_user_row_read.htm', $item['faqid']);
                $faqs[] = $item;
            }
        }
        ...
        // Return the output that has been generated by this function
        return $this->view->fetch('faq_user_view.htm');
    }
    ...
    public function display($args)
    {
        ...
        if ($this->view->is_cached('faq_user_display.htm')) {
            return $this->view->fetch('FAQ_user_display.htm');
        }
    ...
    public function ask()
    {
        ...
        // Return the output that has been generated by this function
        return $this->view->fetch('faq_user_ask.htm');
